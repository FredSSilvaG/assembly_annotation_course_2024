.libPaths("/data/users/fsilvagutierrez/03_Semester/assembly_course_2024/scripts/R/library")
if (!requireNamespace('tidyverse', quietly = TRUE)) {
    install.packages('tidyverse', repos = "https://cloud.r-project.org/", lib = "/data/users/fsilvagutierrez/03_Semester/assembly_course_2024/scripts/R/library")
  }
if (!requireNamespace('data.table', quietly = TRUE)) {
    install.packages('data.table', repos = "https://cloud.r-project.org/", lib = "/data/users/fsilvagutierrez/03_Semester/assembly_course_2024/scripts/R/library")
  }
if (!requireNamespace('cowplot', quietly = TRUE)) {
    install.packages('cowplot', repos = "https://cloud.r-project.org/", lib = "/data/users/fsilvagutierrez/03_Semester/assembly_course_2024/scripts/R/library")
  }
if (!requireNamespace('UpSetR', quietly = TRUE)) {
    install.packages('UpSetR', repos = "https://cloud.r-project.org/", lib = "/data/users/fsilvagutierrez/03_Semester/assembly_course_2024/scripts/R/library")
  }
if (!requireNamespace('ComplexUpset', quietly = TRUE)) {
    install.packages('ComplexUpset', repos = "https://cloud.r-project.org/", lib = "/data/users/fsilvagutierrez/03_Semester/assembly_course_2024/scripts/R/library")
  }
...
dat <- fread("/data/users/fsilvagutierrez/03_Semester/assembly_course_2024/Annotation/Rld-2/GENESPACE/orthof
inder/Results_Nov19/Comparative_Genomics_Statistics/Statistics_PerSpecies.tsv", header = T, fill = TRUE)
...
p <- ggplot(ortho_ratio, aes(x = V1, y = perc, fill = species)) +
    ...
    labs(y = "Count")
ggsave("Plots/orthogroup_plot.pdf", create.dir = TRUE)
...
orthogroups <- fread("/data/users/fsilvagutierrez/03_Semester/assembly_course_2024/Annotation/Rld-2/GENESPACE/orthof
inder/Results_Nov19/Orthogroups/Orthogroups.GeneCount.tsv")
